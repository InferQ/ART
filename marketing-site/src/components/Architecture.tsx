...
const architectureLayers = [
  {
    ...
    items: ['React Components', 'UI Integration', 'State Hooks'],
  },
  {
    ...
    items: ['ThreadConfig', 'AgentState', 'Message History', 'Plan Tracking'],
  },
  {
    ...
    items: ['PESAgent', 'ProviderManager', 'OutputParser', 'Plan Management'],
    isCore: true,
  },
  {
    ...
    description: 'Tool and resource access',
    items: ['ToolRegistry', 'Custom Tools', 'MCP Integration', 'A2A Tasks'],
  },
  {
    ...
    items: ['ObservationManager', 'Streaming Updates', 'Debug Insights'],
  },
];
