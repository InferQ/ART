...
const workflowStages = [
  ...
  },
  {
    ...
    glowColor: 'indigo',
    description: 'Create a structured TodoList with Step Classification',
    longDescription: 'The agent thinks holistically about the request, decomposing complex tasks into discrete steps tagged as either "tool" (action-oriented) or "reasoning" (analytical).',
    details: [
  ...
  },
  {
    ...
    glowColor: 'amber',
    description: 'Tool-Aware Execution with Strict Validation',
    longDescription: 'The engine iterates through the TodoList using the Tool-Aware Execution Framework (TAEF). It strictly validates tool calls, handles HITL suspensions, and adapts plans dynamically.',
    details: [
...
const capabilities = [
  ...
  },
  {
    ...
    description: 'Strictly enforced tool usage prevents hallucinations and ensures reliability',
    stat: '100%',
    statLabel: 'Enforcement',
  },
  {
    icon: MessageSquare,
  ...
  },
  {
    ...
    description: 'Robust suspension and rejection handling for human oversight',
    stat: 'Control',
